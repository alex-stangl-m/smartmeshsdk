...
class ConfigChanged(object):
    ...
    def __init__(self):
        """
        ConfigChanged - a model defined in Swagger
    ...
    def sys_time(self):
        """
        Gets the sys_time of this ConfigChanged.
        Time of notification

        :return: The sys_time of this ConfigChanged.
        :rtype: datetime
        """
    ...
    def sys_time(self, sys_time):
        """
        Sets the sys_time of this ConfigChanged.
        Time of notification

        :param sys_time: The sys_time of this ConfigChanged.
        :type: datetime
        """
    ...
    def module(self):
        """
        Gets the module of this ConfigChanged.
        Module that was changed (e.g. network, users)

        :return: The module of this ConfigChanged.
        :rtype: str
        """
        return self._module
    ...
    def module(self, module):
        """
        Sets the module of this ConfigChanged.
        Module that was changed (e.g. network, users)

        :param module: The module of this ConfigChanged.
        :type: str
        """
    ...
    def type(self):
        """
        Gets the type of this ConfigChanged.
        Notification type

        :return: The type of this ConfigChanged.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this ConfigChanged.
        Notification type

        :param type: The type of this ConfigChanged.
        :type: str
        """
