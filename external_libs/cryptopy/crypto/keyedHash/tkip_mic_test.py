...
class TKIP_MIC_Tests(unittest.TestCase):
    ...
    def testAdrianExample1(self):
        ...
        print("==== Test 1 Adrian ====")
        # raw data
        k0 = 0x00000000      # assume is a 'dword'
        k1 = 0x00000000
    ...
    def testParagExample1(self):
        ...
        payload = pack('<IIIIIIIIIII',0xdeaf0005, 0xdeaf0006, 0xdeaf0007, 0xdeaf0008, 0xdeaf0009, 0xdeaf000a, 0xdeaf000b, 0xdeaf000c, 0xdeaf000d, 0xdeaf000e, 0x00ccdd00)
